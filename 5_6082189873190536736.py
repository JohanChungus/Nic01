...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}Vano_Ganzzz            │ Version {R}:{G} 3.0{W}             │
  {W}│ Github{R}:{G}github.com/johanchungus {W}│ {W}Your Ip {R}:{Y} {ip}   {W}│
  {W}│ Team{R}:{W}Lao Gin Ma {biru}Team         {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "2":
        ...
        tanya()
    if pil == "3":
        os.system("xdg-open https://wa.me/6281559764182")
